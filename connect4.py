...
# Get the next available row for a piece to be placed in the specified column
...
# Check if a player has won with four consecutive pieces
...
# Evaluate a window for the AI to make the best move
...
# Score the position to help the AI make the best move
...
# Check if the current node is a terminal node (end of game)
...
# Get valid locations where a piece can be placed
